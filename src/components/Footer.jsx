...
const Footer = () => {
  return (
    <footer className="bg-[#C19B76] text-white py-10 px-6 lg:px-20 mt-10 md:mt-[60px] lg:mt-[80px] 2xl:mt-[120px]">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white hover:cursor-pointer">
            <li>Accommodation</li>
            <li>Dine & Drink</li>
            <li>Spa & Leisure</li>
            <li>Services</li>
